...
Recall that Eq.~1 in the main text defined the
...
that is bounded according to Eq.~2 from the main text 
(reproduced here):
\begin{equation}
	\theta \geq 2\eta - 1.
	\label{eq:sup:l1}
...
We reproduce the plot from Fig.~2A in the main text, 
...
as shown in in Fig.~2A of the main text, are representative.
...
Figs.~2A and B are tabulated in Tables~S\ref{table:theta} and
